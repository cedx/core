...
abstract class XmlTools {
	...
	public static function addChildElement(element: Xml, name: String, ?value: String, ?attributes: Map<String, String>): Xml {
	...
	public static function createElement(name: String, ?value: String, ?attributes: Map<String, String>): Xml {
