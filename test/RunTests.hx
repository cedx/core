...
function main() {
	final tests = TestBatch.make([
		...
		#if (asys && !hl && !java) new belin_core.caching.FileCacheTest(), #end
		...
		#if (js && !nodejs)
		new belin_core.html.ElementToolsTest(),
		new belin_core.html.FileToolsTest(),
		new belin_core.html.FormToolsTest(),
		#end
		#if (nodejs || sys) new belin_core.io.FileTest(), #end
