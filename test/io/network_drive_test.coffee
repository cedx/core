...
describe "NetworkDrive", ->
	...
	describe "fromUri()", ->
		it "should parse the specified file URI", ->
			networkDrive = NetworkDrive.fromUri new URL "smb://localhost/folder"
	...
	describe "resolve()", ->
		it "should resolve an UNC path into a local path", ->
			networkDrive = new NetworkDrive "Z", "\\\\localhost\\share"
	...
	describe "resolveUri()", ->
		it "should return the path as is for a local path", ->
		...
		it "should return a mapped path for a UNC path", ->
